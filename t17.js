...
rl.question('How many T17 40TH you own?: ', (n) => {
    if (isNaN(n)) {
    ...
    rl.question('What is your investment in USD? ($2513.00) ', (investment) => {
        if (isNaN(investment)) {
            console.log("You must enter a number smartass");
            rl.close();
            process.stdin.destroy();
        ...
        rl.question('Cost in electricity in USD? (115.86$) ', (cost) => {
            ...
            var url = "https://www.coincalculators.io/api?name=bitcoin&hashrate=40000000000000&power=2200&powercost=0&difficultytime=0";
