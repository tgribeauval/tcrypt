...
rl.question('How many S9s you own?: ', (n) => {
    ...
    rl.question('What is your investment in USD? (342.50$) ', (investment) => {
        if (isNaN(investment)) {
            console.log("You must enter a number smartass");
            rl.close();
            process.stdin.destroy();
        ...
        rl.question('Cost in electricity in USD?(89.05$) ', (cost) => {
            ...
            var url = "https://www.coincalculators.io/api?name=bitcoin&hashrate=13500000000000&power=1480&powercost=0&difficultytime=0";
