...
rl.question('How many Inno T2 you own?: ', (n) => {
    if (isNaN(n)) {
    ...
    rl.question('What is your investment in USD? (1495.56$) ', (investment) => {
        if (isNaN(investment)) {
            console.log("You must enter a number smartass");
            rl.close();
            process.stdin.destroy();
        ...
        rl.question('Cost in electricity in USD? (133.95$) ', (cost) => {
            ...
            var url = "https://www.coincalculators.io/api?name=bitcoin&hashrate=30000000000000&power=2100&powercost=0&difficultytime=0";
